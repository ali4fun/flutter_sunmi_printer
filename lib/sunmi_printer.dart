...
class SunmiPrinter {
  ...
  static Future<void> printBarcode({required String code, required int barcodeType, required int textPosition, int width = 2, required int height}) async {
    Map<String, dynamic> arguments = <String, dynamic>{
      'data': code,
  ...
  // set font widget bold
  static Future<void> setFontBold(bool fontBold) async {
    Map<String, dynamic> arguments = <String, dynamic>{"bold": fontBold};
